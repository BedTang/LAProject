...
void I2C_StructInit(I2C_InitTypeDef* I2C_InitStruct)
{
    ...
    //I2C_InitStruct->I2C_OwnAddress1 = 0x2A;// initial   //   ?     ?    ??   ?    ?     ??  ?
...
void I2C_Init(I2C_InitTypeDef* I2C_InitStruct)
{
	...
	//I2C->SADDR = I2C_InitStruct->I2C_OwnAddress1;//   ?     ?    ??   ?    ?     ??  ?
...
void I2C_ReceiveData(FunctionalState ACK, FunctionalState STOP)
{
    ...
    I2C->CR_SR = 0x20 | ACK | STOP;//   ? I2C->DR
	return;
}
...
void I2C_ClearIT()
{
	I2C->CR_SR = 0x01;// IIC     ?    CR                1
	SET_BIT(INT_CLR, IRQ_I2C);// INTC    ?          IIC              1
}
...
/**
  ...
  * @retval None
  */
void I2C_ClearFlag(uint8_t I2C_FLAG)//               I2C_FLAG     ?              ?
{
	uint8_t flagpos = 0;
...
ITStatus I2C_GetStatus(uint8_t I2C_STATUS)
{
	...
	if (((I2C->CR_SR & I2C_STATUS) != (uint8_t)RESET))//       ?   ??        ? ? ?     if
	{
		/* I2C_IT is set */
		bitstatus = SET;
	}
