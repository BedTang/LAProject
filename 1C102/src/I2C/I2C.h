...
// I2C 时序
void I2C_GenerateSTART(FunctionalState NewState);	 // I2C主设备产生start信号
void I2C_GenerateSTOP(FunctionalState NewState);     // I2C主设备产生stop信号
void I2C_AcknowledgeConfig(FunctionalState NewState);// I2C主设备产生ack信号
void I2C_SendData(uint8_t Data);					 // I2C发送数据
void I2C_ReceiveData(FunctionalState ACK, FunctionalState STOP); // I2C接收数据
void I2C_Send7bitAddress(uint8_t Address, uint8_t I2C_Direction);// I2C发送从设备地址
void I2C_wait();									 // I2C等待传输完毕
void I2C_Unlock();									 // I2C解除总线死锁
