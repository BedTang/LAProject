...
#define UART1_MAX_RECV_LEN		16					// 最大接收缓存字节数
#define UART1_MAX_SEND_LEN		16					// 最大发送缓存字节数
#define UART1_RX_EN 			1					// 0，不接收。1，接收。
#define UART0_MAX_RECV_LEN		16					// 最大接收缓存字节数
#define UART0_MAX_SEND_LEN		16					// 最大发送缓存字节数
#define UART0_RX_EN 			1					// 0，不接收。1，接收。

extern uint8_t UART0_RX_BUF[UART0_MAX_RECV_LEN]; 	// 接收缓冲，最大 USART0_MAX_RECV_LEN 字节
extern uint8_t UART0_TX_BUF[UART0_MAX_SEND_LEN]; 	// 发送缓冲，最大 USART0_MAX_SEND_LEN 字节
extern uint8_t UART0_RX_STA;   						// 接收数据状态
